...
class Router
{
    ...
    */ 
     ...
     */
    public function __construct(RouteCollection $routes, RouteCollection $namedRoutes=null)
    {
        $this->_routes = $routes;
        if ($namedRoutes!=null) {
            $this->_namedRoutes = $namedRoutes;
        }
    }
    ...
    */
    ...
    public function generate($routeName, array $params = array())
    {
        ...
        if (!$this->_namedRoutes->get($routeName)) {
            throw new Exception("No route with the name $routeName has been found.");
        }

        $route = $this->_namedRoutes->get($routeName);
        $url = $route->getUrl();
